report 50008 "Purchase Order Report"
{
    ...
    RDLCLayout = './Purchase/layouts Report Purchase/StandardPurchaseOrder.rdl';
    Caption = 'Purchase Order Report(CVH)';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            { }
            column(CompanyAddresss; CompanyInfo.Address)
            { }
            ...
            column(CompanyInfoPiture; CompanyInfo.Picture)
            {
            ...
            column(PaymentTermsDesc; PaymentTermse.Description)
            {
            }
            column(ShipmentMethodDesc; ShipmentMethods.Description)
            {
            }
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                column(Amount; FormattedLineAmount)
                {
                }
                ...
                column(QuantityCabtion; FieldCaption(Quantity))
                {
                }
    ...
    var
        ...
        ShipmentMethods: Record "Shipment Method";
        PaymentTermse: Record "Payment Terms";
...
#pragma warning disable AL0755
        Language: Codeunit Language;
#pragma warning restore AL0755
    ...
    begin
        with PurchaseHeader do begin
            ...
            FormatDocument.SetPaymentTerms(PaymentTermse, "Payment Terms Code", "Language Code");
            FormatDocument.SetPaymentTerms(PrepmtPaymentTerms, "Prepmt. Payment Terms Code", "Language Code");
            FormatDocument.SetShipmentMethod(ShipmentMethods, "Shipment Method Code", "Language Code");
